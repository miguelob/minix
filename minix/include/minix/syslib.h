...
int sys_trapcount(endpoint_t proc_ep, int *trapcounter);
int sys_init_trapcount(endpoint_t proc_ep, int *trapcounter);
int sys_msgcount(endpoint_t proc_ep, int *msgcounter);
int sys_init_msgcount(endpoint_t proc_ep, int *msgcounter);
